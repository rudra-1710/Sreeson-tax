...
<Nav.Link href="#" className='rounded-0'><p className='nav-text rounded-0'>Contact information</p></Nav.Link>

<Nav.Link href="#" className='rounded-0'><p className='nav-text rounded-0'>Dependences information</p></Nav.Link>

<Nav.Link href="#" className='rounded-0'><p className='nav-text rounded-0'>Hemanths's personal information</p></Nav.Link>

<Nav.Link href="#" className='rounded-0'><p className='nav-text rounded-0'>Personal info summery</p></Nav.Link>

<Nav.Link href="#" className='rounded-0'><p className='nav-text rounded-0'>What's new Tax</p></Nav.Link>
<Nav.Link href="#" className='rounded-0'><p className='nav-text rounded-0'>Get strated</p></Nav.Link>
<Nav.Link href="#" className='rounded-0'><p className='nav-text rounded-0'>Personal Tax profile for Hemanth</p></Nav.Link>
        ...
        <Nav.Link href="#" className='mx-2 d-none d-sm-block'>
