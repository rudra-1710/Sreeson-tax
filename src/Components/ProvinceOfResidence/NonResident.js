...
const NonResident = () => {
    const [isNonResidentMove, setisNonResidentMove] = useState(false)
    const [isResideNonResident, setisResideNonResident] = useState(false)
    const [showResidentCountry,setshowResidentCountry]= useState(false)


    const NonResidentHandler =(event)=>{
        console.log(event.target.value)
        
          if(event.target.value === "Yes"){
            setisNonResidentMove(true);
            setisResideNonResident(true)
          }else{
            setisNonResidentMove(false)
            setisResideNonResident(true)
          }
    }
    const resideNonResidentHandler = (event)=>{
        console.log(event.target.value)
        if(event.target.value === "Yes"){
  ...
  return (
   <Container className='NonResident alberta'>
    <div className='d-flex justify-content-center mb-1'>
            <div className='territory '></div>
        </div>
        <div><h6 className='text-center'>Did you move anotherprovince/territory in 2022?</h6></div>
        <form className='statusSinle' onChange={NonResidentHandler}>

            <ul>
            <li><input type="radio" name="test" id="NonResidentYes" value="Yes" />
              <label for="NonResidentYes">
                <div className='imgbar single d-flex justify-content-center align-items-center'><p>Yes</p></div>
            </label>
            </li>
            <li><input type="radio" name="test" id="NonResidentNo" value="No" />
              <label for="NonResidentNo">
        ...
        {isNonResidentMove&& <div className='py-4'>
          <h6 className='text-center'>When did you move?</h6>
          <div className='d-flex justify-content-center'>
            <div>
            <label for="NonResidentdate" className='my-2'><p>An apporximate date is OK</p></label>
        <input type='date' id="NonResidentdate" name='NonResidentdate' className='my-2 date-input' />
            </div>
        </div>
        </div>}
        {isResideNonResident && 
            ...
            <div className='country-logo py-2'>
                ...
                <div><h6 className='text-center'>Which option best describe your residency status as of on December 31, 2022?</h6></div>
                 <form className='statusSinle' onChange={resideNonResidentHandler}>
                    <ul className='resident'>
                    <li><input type="radio" name="test" id="resideNonResident1" value="Yes" />
                    <label for="resideNonResident1">
                        <div className='imgbar single d-flex justify-content-center align-items-center'><p>I was a non-resident of Canada</p></div>
                    </label>
                    </li>
                    <li><input type="radio" name="test" id="resideNonResident2" value="Yes" />
                    <label for="resideNonResident2">
                    ...
                    <li><input type="radio" name="test" id="resideNonResident3" value="Yes" />
                    <label for="resideNonResident3">
                    ...
                    <li><input type="radio" name="test" id="resideNonResident4" value="Yes" />
                    <label for="resideNonResident4">
        ...
        <label for="NonResident" className='my-2'><p>Country of residence on December 31,2022</p></label>
         <select id="NonResident" name='NonResident' className='my-2 date-input-NonResident' >
