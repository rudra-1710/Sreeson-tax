...
const NonResidentS216 = () => {
    const [isNonResidentS216Move, setisNonResidentS216Move] = useState(false)
    const [isNonResidentS216, setisNonResidentS216] = useState(false)
    ...
    const NonResidentHandlerHandler =(event)=>{
        console.log(event.target.value)
          ...
          if(event.target.value === "Yes"){
            setisNonResidentS216Move(true);
            setisNonResidentS216(true)
          }else{
            setisNonResidentS216Move(false)
            setisNonResidentS216(true)
          }
    }
    const NonResidentS216Handler = (event)=>{
        console.log(event.target.value)
        if(event.target.value === "Yes"){
  ...
  return (
   <Container className='NonResidentS216 alberta'>
    <div className='d-flex justify-content-center mb-1'>
        ...
        <form className='statusSinle' onChange={NonResidentHandlerHandler}>
            ...
            <ul>
            <li><input type="radio" name="test" id="NonResidentS216Yes" value="Yes" />
              <label for="NonResidentS216Yes">
                <div className='imgbar single d-flex justify-content-center align-items-center'><p>Yes</p></div>
            </label>
            </li>
            <li><input type="radio" name="test" id="NonResidentS216No" value="No" />
              <label for="NonResidentS216No">
        ...
        {isNonResidentS216Move&& <div className='py-4'>
          <h6 className='text-center'>When did you move?</h6>
          <div className='d-flex justify-content-center'>
            <div>
            <label for="NonResidentS216date" className='my-2'><p>An apporximate date is OK</p></label>
        <input type='date' id="NonResidentS216date" name='NonResidentS216date' className='my-2 date-input' />
            </div>
        </div>
        </div>}
        {isNonResidentS216 && 
            ...
            <div className='country-logo py-2'>
                ...
                <div><h6 className='text-center'>Which option best describe your residency status as of on December 31, 2022?</h6></div>
                 <form className='statusSinle' onChange={NonResidentS216Handler}>
                    <ul className='resident'>
                    <li><input type="radio" name="test" id="resideNonResidentS2161" value="Yes" />
                    <label for="resideNonResidentS2161">
                        <div className='imgbar single d-flex justify-content-center align-items-center'><p>I was a non-resident of Canada</p></div>
                    </label>
                    </li>
                    <li><input type="radio" name="test" id="resideNonResidentS2162" value="Yes" />
                    <label for="resideNonResidentS2162">
                    ...
                    <li><input type="radio" name="test" id="resideNonResidentS2163" value="Yes" />
                    <label for="resideNonResidentS2163">
                    ...
                    <li><input type="radio" name="test" id="resideNonResidentS2164" value="Yes" />
                    <label for="resideNonResidentS2164">
        ...
        <label for="NonResidentS216" className='my-2'><p>Country of residence on December 31,2022</p></label>
         <select id="NonResidentS216" name='NonResidentS216' className='my-2 date-input-NonResident' >
...
export default NonResidentS216